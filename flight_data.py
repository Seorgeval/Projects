class FlightData:
    ...
    def __init__(self, price, origin_airport, destination_airport, depart_date, return_date):
        ...
        - depart_date: The departure date for the flight.
...
def find_cheapest_flight(data):
    ...
    # Handle empty data if no flight or Amadeus rate of requests limit exceeded.
    if data is None or not data['data']:
        print("No flight data or requests limit exceeded")
